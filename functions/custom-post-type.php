...
// for index testimonial custom post type 
function create_testimonial_post_type() {
    $labels = array(
        'name'               => _x( 'Testimonials', 'post type general name', 'doc_pro' ),
        'singular_name'      => _x( 'Testimonial', 'post type singular name', 'doc_pro' ),
        'menu_name'          => _x( 'Testimonials', 'admin menu', 'doc_pro' ),
        'name_admin_bar'     => _x( 'Testimonial', 'add new on admin bar', 'doc_pro' ),
        'add_new'            => _x( 'Add New', 'testimonial', 'doc_pro' ),
        'add_new_item'       => __( 'Add New Testimonial', 'doc_pro' ),
        'new_item'           => __( 'New Testimonial', 'doc_pro' ),
        'edit_item'          => __( 'Edit Testimonial', 'doc_pro' ),
        'view_item'          => __( 'View Testimonial', 'doc_pro' ),
        'all_items'          => __( 'All Testimonials', 'doc_pro' ),
        'search_items'       => __( 'Search Testimonials', 'doc_pro' ),
        'parent_item_colon'  => __( 'Parent Testimonials:', 'doc_pro' ),
        'not_found'          => __( 'No testimonials found.', 'doc_pro' ),
        'not_found_in_trash' => __( 'No testimonials found in Trash.', 'doc_pro' ),
    );
    ...
    $args = array(
        ...
        'show_in_menu'       => true,
        'query_var'          => true,
        'rewrite'            => array( 'slug' => 'testimonial' ), // Customize the URL slug
        'capability_type'    => 'post',
        'has_archive'        => true,
        'hierarchical'       => false,
        'menu_position'      => null,
        'supports'           => array( 'title', 'editor', 'thumbnail', 'excerpt' ), // Customize supported features
    );
